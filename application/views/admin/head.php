...
<script type="text/javascript" src="<?php echo public_url('') ?>/js_chung/jquery/jquery.min.js"></script>
<script type="text/javascript" src="<?php echo public_url('') ?>/js_chung/jquery/jquery-ui.min.js"></script>
...
<script type="text/javascript" src="<?php echo public_url('') ?>/js_chung/jquery/formatCurrency/jquery.formatCurrency-1.4.0.min.js"></script>
<script type="text/javascript" src="<?php echo public_url('') ?>/js_chung/jquery/zclip/jquery.zclip.js"></script>

<script type="text/javascript" src="<?php echo public_url('') ?>/js_chung/jquery/colorbox/jquery.colorbox.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo public_url('') ?>/js_chung/jquery/colorbox/colorbox.css" media="screen" />

<script type="text/javascript" src="<?php echo public_url('') ?>/js_chung/custom_admin.js" type="text/javascript"></script>
