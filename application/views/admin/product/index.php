		...
		<form class="list_filter form" action="<?php echo admin_url('product') ?>" method="get">
			<table cellpadding="0" cellspacing="0" width="80%"><tbody>
				...
				<tr>
					...
					<td class="item" style="width:155px;" ><input name="name" value="<?php $this->input->get('name') ?>" id="filter_iname" type="text" style="width:155px;" /></td>
			...
			<b><?php echo $row->name ?></b>
				...
				<td class="textR">
				 <?php if ($row->discount >0): ?>
				 	...
				 	<b style="color: red; font: boild;"><?php echo number_format($price_new) ?></b>
				 	<p style='text-decoration:line-through'><?php echo number_format($row->price) ?> đ</p>
				 <?php else: ?>
				 	<b style="color: red; font: boild;"><?php echo number_format($row->price) ?></b>
				 <?php endif; ?>             				
				</td>
				...
				<a  href="<?php echo admin_url('') ?>" target='_blank' class='tipS' title="Xem chi tiết sản phẩm">
